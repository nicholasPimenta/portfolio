...
function Projects() {
  ...
  return (
    <section id="projetos" className="px-11 py-14 mx-auto max-w-4xl">
      <div className="flex flex-row justify-start items-center gap-6 mb-8">
      ...
      <article aria-labelledby="form-title">
        <div className="grid grid-cols-2 gap-8 items-center mb-16">
          <div className="grid min-w-0 gap-2">
            <figure className="bg-background-card border border-border-card p-2 rounded-2xl">
              <img
            ...
            <button
              ...
              className="text-text flex items-center gap-2 py-1 hover:text-text-secondary cursor-pointer duration-200 ease-linear"
              onClick={
          ...
          <div className="grid min-w-0 gap-3.5">
            <h3
              id="form-title"
              className="text-2xl leading-[1.3] font-medium tracking-tight"
            >
            ...
            <ul aria-label="Tecnologias" className="flex flex-wrap gap-2">
              <li className="px-2.5 py-1.5 bg-button-hover text-accent rounded-lg">
                React
              </li>
              <li className="px-2.5 py-1.5 bg-button-hover text-accent rounded-lg">
                TypeScript
            ...
            <div className="flex flex-row justify-start gap-4 items-center">
              <a
                ...
                className="border border-accent bg-button-hover hover:bg-border-card px-4 py-3 rounded-xl flex flex-row duration-200 ease-linear gap-2 items-center"
              >
                Ver projeto
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-row border border-accent hover:bg-border-card px-4 py-3 rounded-xl duration-200 ease-linear gap-2 items-center"
              >
                Ver código
            ...
            <button
              ...
              className="text-accent flex flex-row items-center gap-2 cursor-pointer"
              onClick={
        ...
        <div
          id="form-details"
          className="grid grid-cols-2 gap-x-7 gap-y-8 p-7 border border-border-card rounded-[18px] border-t-3 border-t-main bg-background-card mt-16"
          hidden={!isContentFormExpanded}
        >
          <div className="text-text">
            <h4 className="tracking-tight mb-2 font-bold text-base">
              Problema e contexto
            </h4>
            <p className="tracking-tight leading-[1.65] font-normal">
          ...
          <div className="text-text col-span-2 py-5 border border-y-border-card border-x-transparent">
            <h4 className="tracking-tight mb-2 font-bold text-base">
              Estado atual
            </h4>
            <p>
          ...
          <figure className="col-span-2 flex flex-col justify-center items-center">
            <h4 className="tracking-tight mb-2 font-bold text-base text-text self-start">
              Do preenchimento à saída A4
            </h4>
            <button
              aria-expanded={isDocumentFormExpanded}
              aria-controls="form-document"
              className="flex flex-row items-center gap-2 mx-auto my-6 cursor-pointer"
              onClick={
            ...
            >
              ...
              />
              <figcaption className="text-sm text-text text-center mt-4">
      ...
      <article aria-labelledby="weather-title">
        ...
        >
          ...
          <div className="text-text col-span-2 py-5 border border-t-border-card border-transparent">
            <h4 className="tracking-tight mb-2 font-bold text-base">
              Estado atual
            </h4>
            <p>
      ...
      <article aria-labelledby="lenovo-title">
        ...
        >
          ...
          <figure className="flex flex-col justify-center items-center col-span-2">
              <img
                src={lenovoPage}
                ...
                className="rounded-xl"
              />
              <figcaption className="text-sm text-text text-left mt-4 border border-transparent border-b-border-card pb-6 mb-6">
          ...
          <figure className="flex flex-col justify-center items-center col-span-2">
              <img
                ...
                className="rounded-xl"
              />
              <figcaption className="text-sm text-text text-left mt-4">
