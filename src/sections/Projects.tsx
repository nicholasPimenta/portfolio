    ...
    <section id="projetos" className="border-b border-line mb-12">
      <div className="px-6 md:px-11 py-6 mx-auto max-w-6xl">
        ...
        <article
          ...
          className="border border-x-transparent border-t-transparent border-b-border-card mb-6"
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-16">
            ...
            <div className="grid min-w-0 gap-3.5">
              ...
              <p className="text-text text-sm md:text-base">
                Da necessidade ao formulário: uma interface de preenchimento e
                um documento A4, desenvolvidos a partir de uma demanda real de
                um urologista.
              </p>
              <ul
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-16">
            ...
            <div className="grid min-w-0 gap-3.5">
              ...
              <p className="text-text text-sm md:text-base">
                ...
                quatro dias seguintes e cenários visuais que acompanham o clima
                e o período do dia.
              </p>
              <ul
                aria-label="Tecnologias"
          ...
          >
            <div className="text-text">
              ...
              <p className="tracking-tight leading-[1.65] font-normal text-sm md:text-base">
                ...
                meteorológicos e o comportamento da interface durante a
                consulta, do carregamento até a exibição de um resultado ou
                erro.
              </p>
            </div>
            <div className="text-text">
              ...
              <p className="tracking-tight leading-[1.65] font-normal text-sm md:text-base">
                Da pesquisa visual à integração dos dados, trabalhei na
                interface de busca e na apresentação das condições atuais e da
                previsão. Também revisei a lógica que reúne os dados dos
                próximos dias.
              </p>
            </div>
            <div className="text-text">
            ...
            <div className="text-text">
              ...
              <p className="tracking-tight leading-[1.65] font-normal text-sm md:text-base">
                A agregação da previsão exigiu correções. Usei sugestões do
                GitHub Copilot para explorar soluções, revisando e ajustando o
                código antes de incorporá-lo. O trabalho mostrou a importância
                de conferir como os dados da API se tornam informação na tela.
              </p>
            </div>
          ...
          >
            ...
            <div className="text-text">
              ...
              <p className="tracking-tight leading-[1.65] font-normal text-sm md:text-base">
                ...
                composição e permite visualizar as duas versões sem sair da
                seção.
              </p>
            </div>
            <div className="text-text">
            ...
            <div className="text-text col-span-1 md:col-span-2 py-5 border border-y-border-card border-x-transparent">
              ...
              <p className="tracking-tight leading-[1.65] font-normal text-sm md:text-base">
                ...
                projeto conceitual independente, sem vínculo oficial com a
                Lenovo.
              </p>
            </div>
